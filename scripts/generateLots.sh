...
nohup curl 'http://localhost:8083/generateData?noOfCustomers=5000&noOfTransactions=100000&noOfDays=10&noOfThreads=50&key_suffix=C' > /tmp/generateC.out 2>&1 &
nohup curl 'http://localhost:8084/generateData?noOfCustomers=5000&noOfTransactions=100000&noOfDays=10&noOfThreads=50&key_suffix=A' > /tmp/generateA.out 2>&1 &
nohup curl 'http://localhost:8085/generateData?noOfCustomers=5000&noOfTransactions=100000&noOfDays=10&noOfThreads=50&key_suffix=G' > /tmp/generateG.out 2>&1 &
